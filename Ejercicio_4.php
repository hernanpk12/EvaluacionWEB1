  ...
  <ul class="navbar-nav mr-auto">
    ...
    <div class="container">
       <div class="row justify-content-center">
          ...
          <h4>Salario Trabajador</h4>
          <div class="row">
             <div class="col">
             <input type="text" class="form-control" placeholder="Ingresar la cantidad" name = "Horas">
             </div>
             <div class="col">
             <input type="text" class="form-control" placeholder="Ingresar precio hora" name ="Precio">
             </div>
          </div>
   ...
   <div class="container">
       <div class="row justify-content-center">
          ...
          if(isset($_POST["BotonCalcular"])){
              ...
              $preciodehoras = $_POST["Precio"];

              $salario = $horastrabajadas*$preciodehoras;

              if ($horastrabajadas > 40){
                  $salario = ($salario+$extras)*$horastrabajadas;
